...
Follow the existing format of markdown and code. JavaScript code added should adopt [Standard style](https://standardjs.com/). Run `pnpm fmt` to format English markdown and MDX content with Oxfmt before submitting changes.
