...
- Games: Tic-Tac-Toe, Snake, Tetris, Minesweeper, Connect 4, Whack-a-mole.
...
1. Code out your solution and explain your code to your interviewer while you are coding.
   ...
   - Follow our [User Interface Best Practices](/front-end-interview-guidebook/user-interface-best-practices) for a list of things to take note of during User Interface coding interviews.
...
1. Read our User Interface coding deep dive guides:
   - [Best Practices for Building User Interfaces](/front-end-interview-guidebook/user-interface-best-practices)
