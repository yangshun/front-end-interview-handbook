...
1. Implement a utility function/class commonly found in libraries/frameworks.
...
1. Optional: Explain the time/space complexity if the code involved algorithmic optimizations.
