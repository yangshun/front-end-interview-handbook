...
1. Prepare for the most common **front end interview question types** (quiz, coding, system design, behavioral).
1. [**Practice questions**](/questions) across the most common front end interview formats along with **quality solutions** written by ex-FAANG Senior Engineers.
...
1. **Client applications**: Examples include Newsfeed, Photo sharing application
1. **Complex user interface components**: Examples include Autocomplete, Poll widget
...
{/* [Read more about Behavioral Interviews](/front-end-interview-guidebook/behavioral) */}
