...
1.  Follow relevant blogs, newsletters, podcasts that cover the latest developments in front end technologies and techniques. Give some examples (which you do actually follow) and the content or tech they provide.
    1.  Twitter Influencers
        ...
        2.  [Evan You](https://twitter.com/youyuxi) — Creator of Vue.js and Vite.
        3.  [Rich Harris](https://twitter.com/Rich_Harris) — Creator of Svelte and Rollup.
        4.  [Kent C. Dodds](https://twitter.com/kentcdodds) — Popular React ecosystem course creator.
        5.  [Josh W. Comeau](https://twitter.com/JoshWComeau) — Popular front end course creator.
    2.  Blogs & Magazines
