...
> [!NOTE] Communication is graded from your interview behavior, not just your stories
>
> Traits like conveying complex ideas simply and active listening are often assessed live — whether you interrupt, whether you understand the question asked, and whether your thought process is easy to follow. Prepared content alone will not carry this category.
...
> [!WARNING] Character judgments ("not motivated", "lazy") read as immaturity
>
> Feedback stories that label the person rather than the behavior are a red flag for interviewers — they indicate poor psychological safety instincts. Always describe the specific, observed behavior and its impact, not a trait you inferred.

> [!TIP] One well-chosen cross-functional conflict story covers most collaboration traits
>
> Picking a situation that touches communication, teamwork, disagreement, and feedback at once means you avoid memorizing a separate story for each trait and get more mileage out of each prepared example.
...
> Once it is clear that their behaviors may constitute a concerning pattern, I would let them know in a timely manner. For instance, I had a teammate on a project who had missed bug fix timelines regularly, and once it happened a number of times, I scheduled a private meeting with them to talk about it. I focused on framing the conversation as a growth opportunity on top of what was already appreciated about them, which was their knowledge and mentorship as a senior developer. Instead of describing a general behavior such as "being late", I mentioned the specific tickets that were missed and the impact that had occurred from missing them, as well as its effect on the morale of the team. I then offered a few solutions, such as enacting a new reminder bot within the channel for tickets that were due soon. They were able to understand where I was coming from and our team was able to meet our deadlines much better after that.
