...
As a hiring manager, "Why do you want to work here" is an extremely common question that is probably asked in over 70% of interviews. Yet, most candidates fail to answer this well. In this article, you will learn from ex-interviewers how to answer this question in an effective and concise manner for Front End Engineers/Software Engineers:
...
> [!IMPORTANT] Always close with what you bring to the team, not just why you want in
>
> Stopping at admiration for the product makes you interchangeable with every other fan. Connecting your concrete skills to a problem the team is trying to solve is what turns the answer into a hiring signal.
...
> [!WARNING] Past 90 seconds, this stops sounding like enthusiasm and starts sounding like a monologue
>
> Long answers here eat into the time interviewers have for evaluating other signals. Cap it firmly — any remaining depth about the team is better surfaced through your own questions at the end.

### 2. Gather deep insights about the company/team/position gained from current/previous employees of the company

If you've been an interviewer before, you'd know that most candidates do not impress in the "why do you want to work in this company / team" question because they tend to answer it based on the company's public information, which may not necessarily be representative of the individual team or department's culture or situation. For instance, imagine you are evaluating 2 candidates for a game development team:
...
> [!TIP] Ground your answer in team-specific detail, not company marketing
>
> Anything the interviewer could read on the careers page does not differentiate you. References to the team's stack, recent projects, or individual members' work show real research and let hiring managers picture you on the team.
