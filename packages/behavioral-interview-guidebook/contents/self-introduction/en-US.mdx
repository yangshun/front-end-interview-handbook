...
social_title: Answering "Tell me about yourself" | GreatFrontEnd
---
...
> [!TIP] Keep the self introduction under 1 minute by default
>
> In coding rounds, every second spent introducing yourself is a second not spent solving the problem. Longer intros only make sense when the round explicitly evaluates fit or invites a portfolio walkthrough.
...
> [!CAUTION] Going deep this early reads as over-eager, not impressive
>
> Interviewers decide the pace of the deep-dive — launching into dense technical detail during the intro can come across as trying to preempt their questions. Keep claims at a summary level here; let the follow-ups pull out the depth.
...
> [!NOTE] Only showcase a portfolio when the format explicitly allows it
>
> Behavioral and startup-style rounds often welcome a short portfolio walkthrough; fixed-format coding rounds almost never do. Allude to the portfolio and offer it for the end of the interview rather than opening with it.
