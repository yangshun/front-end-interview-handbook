...
> [!TIP] Prefer a custom hook over an HOC or render prop in modern React code
>
> Hooks share logic without wrapping the component tree, avoiding the "wrapper hell" and prop-collision problems HOCs introduced. Reach for HOCs only when integrating with class-component codebases.
