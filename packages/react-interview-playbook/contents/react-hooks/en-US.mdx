...
- **Pitfalls**: Overusing `useRef` for state instead of [`useState`](#usestate)
...
❌ **Wrong: Calling hooks inside a condition**
...
❌ **Wrong: Calling a hook outside a component**
...
❌ **Wrong: Calling hooks inside an event handler**
