...
> [!NOTE] Skip the bleeding-edge topics unless the job description names them
>
> Suspense for data, Server Components, and the React Compiler are still rolling out industry-wide. Most interviewers assess widely-adopted patterns; study these only after the fundamentals are solid.
