...
Now that you are familiar with form submission, try out a follow up question, [Signup Form](/questions/user-interface/signup-form), where you will be asked to make an AJAX-form request and client-side validation
