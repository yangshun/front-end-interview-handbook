...
The default whac-a-mole game shown in the diagram is 3 x 3 with predefined durations for the round and how long the mole appears for. In order to make the game customizable, we can introduce the following props:
