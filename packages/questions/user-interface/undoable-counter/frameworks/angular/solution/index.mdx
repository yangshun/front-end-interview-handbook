...
`AppComponent` has straightforward and clear structure - when we call an action from the template it is
 instantly called and handled in our `UndoableCounterService`.
