...
This question is adapted from [FrontendEval's Shopping list question](https://frontendeval.com/questions/shopping-dice).

## Notes for Solution Author

- Make sure to debounce the searching.
- Wrap `<input>` in `<form>` for submit-to-Enter behavior.
- Don't need to add keyboard navigation for autocomplete.
