...
In `AppComponent` we will create our game with given params and manage whole logic.
`WhackAMoleComponent` will be dumb component only for displaying UI and reacting on events.
