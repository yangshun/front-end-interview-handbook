...
The following explanation assumes you have a good understanding of [Transfer List's Angular solution](/questions/user-interface/transfer-list/angular/solution).
