...
The following explanation assumes you have a good understanding of [Transfer List's React solution](/questions/user-interface/transfer-list/react/solution).
