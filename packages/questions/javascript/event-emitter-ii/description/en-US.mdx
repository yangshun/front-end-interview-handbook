...
excerpt: Implement a class that can subscribe to and emit events which triggers attached callback functions. Subcription objects are returned and can unsubscribe itself
---
