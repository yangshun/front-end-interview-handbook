...
Implement a function `mapAsync` that accepts an array of items and maps each element with an synchronous mapping function. The function should return a `Promise` which resolves to the mapped results.
