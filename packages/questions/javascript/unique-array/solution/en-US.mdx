...
import uniqueArray from '../setup/src/unique-array';
import uniqueArrayQuadratic from '../setup/src/uniqueArrayQuadratic';
import uniqueArraySet from '../setup/src/uniqueArraySet';
...
<MDXCodeBlock>{uniqueArrayQuadratic}</MDXCodeBlock>
...
<MDXCodeBlock>{uniqueArraySet}</MDXCodeBlock>
...
<MDXCodeBlock>{uniqueArray}</MDXCodeBlock>
