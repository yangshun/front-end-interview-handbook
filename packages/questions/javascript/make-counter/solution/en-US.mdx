...
import makeCounter from '../src/make-counter';
import makeCounterPostfixIncrement from '../src/make-counter-postfix-increment';
import makeCounterMutateParameter from '../src/make-counter-mutate-parameter';
