...
import makeCounter from '../setup/src/make-counter';
import makeCounterPostfixIncrement from '../setup/src/make-counter-postfix-increment';
import makeCounterMutateParameter from '../setup/src/make-counter-mutate-parameter';
...
<MDXCodeBlock>{makeCounterPostfixIncrement}</MDXCodeBlock>
...
<MDXCodeBlock>{makeCounterMutateParameter}</MDXCodeBlock>
