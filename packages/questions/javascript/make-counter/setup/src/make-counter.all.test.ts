import makeCounterGFE from './make-counter';
import makeCounterMutateParameter from './make-counter-mutate-parameter';
import makeCounterPostfixIncrement from './make-counter-postfix-increment';

describe('makeCounter', () => {
  [
    makeCounterGFE,
    makeCounterMutateParameter,
    makeCounterPostfixIncrement,
  ].forEach((makeCounter) => {
