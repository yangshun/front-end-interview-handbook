...
Here's a solution that is based off the [`Array.prototype.filter` ECMAScript specification](https://tc39.es/ecma262/multipage/array-filtered-collections.html#sec-array.prototype.filter).
...
- [`Array.prototype.filter` ECMAScript specification](https://tc39.es/ecma262/multipage/array-filtered-collections.html#sec-array.prototype.filter)
