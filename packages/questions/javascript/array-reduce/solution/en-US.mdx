...
Here's a solution that is based off the [`Array.prototype.reduce` ECMAScript specification](https://tc39.es/ecma262/multipage/array-reduceed-collections.html#sec-array.prototype.reduce).
...
- [`Array.prototype.reduce` ECMAScript specification](https://tc39.es/ecma262/multipage/array-reduceed-collections.html#sec-array.prototype.reduce)
