...
import jQueryClassManipulation from '../src/jquery-class-manipulation';
import jQueryClassManipulationClass from '../src/jQueryClassManipulationClass';
...
<MDXCodeBlock>{jQueryClassManipulation}</MDXCodeBlock>
