...
Remove an item at the top of the stack and returns that item.

- Returns
  - `{*} item`: The item at the top of the stack (before removal) if it is not empty, `undefined` otherwise.
- Time Complexity
  - O(1)
