...
import resumableInterval from '../setup/src/resumable-interval';
import resumableIntervalStateMachine from '../setup/src/resumable-interval-state-machine';
...
<MDXCodeBlock>{resumableInterval}</MDXCodeBlock>
...
<MDXCodeBlock>{resumableIntervalStateMachine}</MDXCodeBlock>
