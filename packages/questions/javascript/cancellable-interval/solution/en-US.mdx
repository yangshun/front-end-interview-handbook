...
import cancellableInterval from '../src/cancellable-interval';
import cancellableIntervalAlt from '../src/cancellable-interval-alt';
import cancellableIntervalBoolean from '../src/cancellable-interval-boolean';
...
<MDXCodeBlock>{cancellableInterval}</MDXCodeBlock>
