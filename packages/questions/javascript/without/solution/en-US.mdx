...
### Solution 1: Uses Set to filter the values
...
### Solution 2: Uses `Array.prototype.filter`
...
### Solution 3: Uses `Array.prototype.filter` to filter the Set instead of manually checking the values
