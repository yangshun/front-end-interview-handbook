...
1. Loop through the keys with the good old `for ... in` statement
1. Converting the object into an array of keys with `Object.keys()`, or an array of key-value pairs with `Object.entries()`
...
Here is the second solution and you might find easier to understand than the previous solution.
