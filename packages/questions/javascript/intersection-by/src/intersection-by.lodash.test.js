...
describe('intersectionBy', () => {
  test('should return the intersection of arrays based on iteratee function', () => {
    ...
    expect(intersectionBy(arr1, arr2, arr3, iteratee)).toEqual([2.1]);
  });
  ...
  test('should handle empty arrays', () => {
    ...
    expect(intersectionBy(arr1, arr2, arr3, iteratee)).toEqual([]);
  });
  ...
  test('should handle arrays with multiple intersections', () => {
    ...
    const arr3 = [4.5, 2.3, 3.4];
    const iteratee = Math.floor;

    expect(intersectionBy(arr1, arr2, arr3, iteratee)).toEqual([1.2, 2.3]);
  });
  ...
  test('should handle arrays with non-primitive values', () => {
    ...
    expect(intersectionBy(arr1, arr2, iteratee)).toEqual([obj2]);
  });
  ...
  it('should handle arrays with different iteratee values', () => {
    ...
    expect(intersectionBy(arr1, arr2, arr3, iteratee)).toEqual(['pear']);
  });
});
