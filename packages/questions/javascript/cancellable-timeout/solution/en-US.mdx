...
import cancellableTimeout from '../src/cancellable-timeout';
import cancellableTimeoutAlt from '../src/cancellable-timeout-alt';
import cancellableTimeoutBoolean from '../src/cancellable-timeout-boolean';
...
<MDXCodeBlock>{cancellableTimeout}</MDXCodeBlock>
