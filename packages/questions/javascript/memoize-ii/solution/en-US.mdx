...
import memoize from '../src/memoize-ii';
import memoizeTrie from '../src/memoize-ii-trie';
...
### Solution 1: `Map`-based cache and serialized arguments as cache key
...
<MDXCodeBlock>{memoize}</MDXCodeBlock>

### Solution 2: Trie-based cache
