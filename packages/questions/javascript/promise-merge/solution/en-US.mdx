...
import promiseMerge from '../src/promise-merge';
import promiseMergeAll from '../src/promise-merge-all';
import promiseMergeSeries from '../src/promise-merge-series';
...
<MDXCodeBlock>{promiseMerge}</MDXCodeBlock>
