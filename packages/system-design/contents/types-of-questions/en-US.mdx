...
> [!TIP] Let the product category decide which deep-dive topics matter
>
...
> [!NOTE] UI component prompts almost always target the interaction-heavy, accessibility-heavy set
>
