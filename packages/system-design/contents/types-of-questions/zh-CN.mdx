...
当今时代，许多网站都是交互式和丰富的应用程序，几乎可以完成许多桌面应用程序可以做的事情。 如果您在网络上使用过 Gmail、Facebook、YouTube、ChatGPT 或 Google 日历，那么您就使用过 Web 应用程序。 Web 应用程序往往具有交互性和动态性（页面上的内容经常变化），并且 Web 应用程序中的页面导航通常不需要完全刷新页面； 该应用程序使用 JavaScript 获取下一页的远程数据，并动态更改内容和 URL。
