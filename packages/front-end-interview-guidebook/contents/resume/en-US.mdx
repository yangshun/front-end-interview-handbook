...
> [!IMPORTANT] Quantify scale, complexity, and impact for every bullet
>
> Generic bullets like "built a website" get filtered out. Numbers such as MAU, load time, Lighthouse score, test coverage, or accessibility improvements give recruiters and hiring managers concrete evidence that your work mattered.
...
> [!TIP] Cap yourself at one or two entries per category
>
> Listing every framework you have touched dilutes your actual strengths and often reads as padding. Two React-family frameworks beats a wall of React, Angular, Vue, Svelte, and Solid — pick the ones you can defend in an interview.
...
- **State Management**: [Redux](https://redux.js.org/), [Flux](https://facebookarchive.github.io/flux/), [Jotai](https://jotai.org/), [Zustand](https://github.com/pmndrs/zustand), [Relay](https://relay.dev/)
