...
1. It passes 3 arguments to the callback: the current element, its index, and the array. The optional `thisArg` sets the callback's `this` value; it is not a fourth argument.
