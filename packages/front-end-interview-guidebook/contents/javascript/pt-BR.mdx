...
1.  Ele passa 3 argumentos para a função de callback: o elemento atual, seu índice e o array. O `thisArg` opcional define o valor de `this` do callback; ele não é um quarto argumento.
...
2.  Escolha um [plano de estudos](/interviews/get-started) e pratique as [perguntas de codificação JavaScript](/questions/formats/javascript-functions) recomendadas para o plano de estudos selecionado. Também está tudo bem estudar um tópico específico enquanto você está fazendo as perguntas.
