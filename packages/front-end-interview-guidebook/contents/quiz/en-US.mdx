...
- How does X technology compare with Y technology?
...
> [!WARNING] Do not memorize quiz answers without understanding them
>
> A canned answer invites follow-up questions that expose surface-level knowledge. Interviewers often drill into whatever you mention, so any term in your response is fair game for a deeper probe.
