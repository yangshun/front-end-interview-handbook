...
System Design interviews can come in many forms and cover the entire development stack. GreatFrontEnd focuses on **Front End System Design**, aka system design and architecture of client applications and UI components rather than back end distributed systems.
...
GreatFrontEnd includes many front end system design case studies and real world examples, including:
