...
class PlatformManager {
    ...
    private async initializePlatform(platform: string): Promise<Platform> {
        const namespaceObject = await import(`../implementations/${platform}Platform`);
        ...
        const platformImplementation: Platform = new RedditPlatform(clientId, clientSecret, userAgent, username,
