...
If you have "Edit" permissions for a file, by pressing <kbd>Esc</kbd> or clicking on the background of the canvas area, you will be able to see available styles in the right sidebar.
