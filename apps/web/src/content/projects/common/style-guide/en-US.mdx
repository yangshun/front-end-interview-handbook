...
The color palette is entirely taken from [Tailwind CSS' default color palette](https://tailwindcss.com/docs/customizing-colors). If you are using Tailwind, using these colors in your code will be a breeze. The following Tailwind CSS colors are frequently used: Neutral, Indigo, Green, Red.
