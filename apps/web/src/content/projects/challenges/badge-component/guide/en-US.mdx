...
If you're wondering about the unconventional naming the CSS classes, we're using the [Block Element Modified (BEM) naming convention](https://en.bem.info/methodology/naming-convention/#naming-rules), which helps make CSS classes easier to read – useful for code bases of all sizes. Of course, you're free to name your classes however you want as long as the resulting appearance is the same, but we recommend the BEM naming convention as many developers use it as well.
