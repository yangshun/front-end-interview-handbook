...
- [Billing Settings Section](/projects/challenges/billing-settings-section)
...
- **Billing plans**: If the user has not filled their billing information, trigger the prompt for them to do so, then lead them to the "Billing" tab, anchor scrolled to the "Billing Information" section. Once the billing information is filled, if there is an immediate payment required (e.g. upgrades), a payment is triggered.
