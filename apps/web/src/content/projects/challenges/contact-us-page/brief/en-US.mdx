In this challenge, you will combine some of the components you have built in previous challenges into a full contact us page.
...
- **Inter-section integration**:
  - **FAQ section**: Upon clicking on "Get in touch" button or "customer support" links, user should smooth-scroll to the Contact Us form and focus on the "Name" input field element.
