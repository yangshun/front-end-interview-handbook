...
- [Pricing Section (Tiers)](https://www.greatfrontend.com/projects/challenges/pricing-section-tiers/resources/guides)
- [FAQ Section](https://www.greatfrontend.com/projects/challenges/faq-section/resources/guides)
- [Features Section (Grid)](https://www.greatfrontend.com/projects/challenges/features-section-grid/resources/guides)
- [Testimonials Section](https://www.greatfrontend.com/projects/challenges/testimonials-section/resources/guides)
...
You can go even further and implement an actual checkout function with a payment gateway like [Stripe](https://stripe.com/) or [PayPal](https://developer.paypal.com/home/). Integration is free because fees are charged per real transaction, so you can try to integrate them for your own learning. To test your integration, you can use the static test card numbers provided by the payment gateway, e.g., [Stripe's](https://docs.stripe.com/testing#cards) and [PayPal's](https://developer.paypal.com/tools/sandbox/card-testing/), which won't count as real transactions, but good enough for you to test your payment flow from start to finish.
