In this challenge, you will develop a responsive metrics section based on the provided designs for desktop, tablet, and mobile views.
...
{/* TODO(projects): implement dynamic content */}
