...
Notable figures in front end development from Meta includes [Jordan Walke](https://twitter.com/jordwalke), the creator of React and Reason; [Joe Savona](https://twitter.com/en_js), who is currently working on the React Forget compiler; [Dan Abramov](https://twitter.com/dan_abramov), [Sebastian Markbåge](https://twitter.com/sebmarkbage), Lauren Tan, Andrew Clark, Dominic Gannaway, Brian Vaughn, [Sophie Alpert](https://twitter.com/sophiebits), Rick Hanlon, who have worked / are still working on React, [Christopher Chedeau](https://twitter.com/Vjeux) of Prettier and CSS-in-JS fame; and [Christoph Nakazawa](https://twitter.com/cpojer), who worked on React Native, Jest, and Metro.
...
ByteDance is home to many talented individuals like [Zack Jackson](https://twitter.com/scriptedalchemy) (Creator of module federation) and [Dexter Yang](https://github.com/dexteryy) ([Author of Spellbook of Modern Webdev](https://github.com/dexteryy/spellbook-of-modern-webdev)). [Anthony Fu](https://github.com/antfu), one of the most prolific open source leaders in recent years, used to work at ByteDance.
