---
title: 5 Biggest CSS Mistakes
description: 5 common CSS mistakes and how to avoid them
imageUrl: /img/blog/5-biggest-css-mistakes.jpg
tags:
  - css
level: starter
...
_This is a guest post by [Jordan Cutler](https://www.linkedin.com/in/jordancutler1/), Senior Frontend Engineer at Qualified and author of the [High Growth Engineer Newsletter](https://careercutler.substack.com/)._
...
![CSS element overflow](/img/blog/5-biggest-css-mistakes/css-element-overflow.png)

If you do need to use a fixed width value, make it flexible. My preferred way for doing that is adding `max-width: 100%` .

![CSS element max width](/img/blog/5-biggest-css-mistakes/css-element-max-width.png)
...
![CSS input width exceed container](/img/blog/5-biggest-css-mistakes/input-width-exceed-container.png)

Once we apply `max-width: 100%` the issue goes away.

![CSS input max width](/img/blog/5-biggest-css-mistakes/input-max-width.png)
...
![CSS height exceed container](/img/blog/5-biggest-css-mistakes/height-exceed-container.png)
...
![CSS height min height](/img/blog/5-biggest-css-mistakes/height-min-height.png)
...
![Tailwind border red](/img/blog/5-biggest-css-mistakes/tailwind-border-red.png)
...
![Tailwind get started](/img/blog/5-biggest-css-mistakes/tailwind-get-started.png)
...
![Tags layout](/img/blog/5-biggest-css-mistakes/tags-layout.png)
...
![MDN CSS position static](/img/blog/5-biggest-css-mistakes/mdn-css-position-static.png)
...
![MDN CSS positioning](/img/blog/5-biggest-css-mistakes/mdn-css-positioning.png)
...
![CSS holy grail layout using grid](/img/blog/5-biggest-css-mistakes/css-holy-grail-layout-grid.png)
...
![Tailwind nav gap CSS](/img/blog/5-biggest-css-mistakes/tailwind-nav-gap-css.png)

Here's one more example on [Airbnb](https://www.airbnb.com/).

![Airbnb nav gap CSS](/img/blog/5-biggest-css-mistakes/airbnb-nav-gap-css.png)
...
You can also check out my newsletter, [High Growth Engineer](https://careercutler.substack.com/), where I share how to grow faster as a software engineer to 50k+ engineers weekly.
