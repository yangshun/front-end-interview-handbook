...
- Declarative: React updates the DOM based on state.
- Component-based: Reusable UI elements with state management.
- Virtual DOM: Efficient updates using a lightweight DOM copy.
- JSX: HTML-like syntax for intuitive UI development.
...
[Read more about it here](/questions/quiz/what-is-jsx-and-how-does-it-work)
...
[Read more about it here](/questions/quiz/how-does-virtual-dom-in-react-work-what-are-its-benefits-and-downsides)

### 5. Difference Between React Node, Element, and Component.
...
[Read more about it here](/questions/quiz/what-is-react-fiber-and-how-is-it-an-improvement-over-the-previous-approach)
...
- Focused on displaying information, not managing behavior. Example:
...
- Handle logic and data management. Example:
...
### 22. What are the recommended ways for static type checking?
...
Hooks enable the use of state and other React features in functional components, removing the need for class components. They streamline code by reducing the reliance on lifecycle methods, enhance readability, and facilitate the reuse of stateful logic across components. Popular hooks like `useState` and `useEffect` are used for managing state and side effects.
...
### 29. What is the purpose of callback function argument format of `setState()` in React and when should it be used?
...
[Read more about it here](/questions/quiz/what-is-the-purpose-of-callback-function-argument-format-of-setstate-in-react-and-when-should-it-be-used)
...
[Read more about it here](/questions/quiz/what-is-the-useid-hook-in-react-and-when-should-it-be-used)

### 34. What does re-rendering mean in React?
...
[Read more about it here](/questions/quiz/what-does-re-rendering-mean-in-react)

### 35. What is `forwardRef()` in React used for?
...
[Read more about it here](/questions/quiz/what-is-forwardref-in-react-used-for)

### 36. Can you explain how to create and use custom hooks in React?
...
[Read more about it here](/questions/quiz/what-is-react-suspense-and-what-does-it-enable)
...
[Read more about it here](/questions/quiz/what-are-react-portals-used-for)
...
- Enforces Best Practices: Flags potential problems, encouraging modern practices. Example
...
[Read more about it here](/questions/quiz/how-would-one-optimize-the-performance-of-react-contexts-to-reduce-rerenders)
...
[Read more about it here](/questions/quiz/what-is-the-flux-pattern-and-what-are-its-benefits)
...
[Read more about it here](/questions/quiz/explain-one-way-data-flow-of-react-and-its-benefits)
...
[Read more about it here](/questions/quiz/what-are-some-react-anti-patterns)
...
[Read more about it here](/questions/quiz/how-do-you-decide-between-using-react-state-context-and-external-state-managers)
...
[Read more about it here](/questions/quiz/explain-the-presentational-vs-container-component-pattern-in-react)
...
[Read more about it here](https://dev.greatfrontend.com/questions/quiz/what-are-render-props-in-react-and-what-are-they-for)
...
[Read more about it here](/questions/quiz/explain-the-composition-pattern-in-react)
...
[Read more about it here](/questions/quiz/how-do-you-handle-asynchronous-data-loading-in-react-applications)
...
[Read more about it here](https://dev.greatfrontend.com/questions/quiz/what-are-some-common-pitfalls-when-doing-data-fetching-in-react)
...
[Read more about it here](/questions/quiz/how-do-you-localize-react-applications)
...
- Translation Management: Simplifies handling translations through message catalogs.
