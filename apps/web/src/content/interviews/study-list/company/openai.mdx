...
1. **OpenAI products**: Firstly, be familiar with the various product offerings by OpenAI
   - [ChatGPT](https://chatgpt.com): Streaming AI chat interface with rich results, voice input, image generation. Read GreatFrontEnd's [Chat App](/system-design/chat-application-messenger) system design solution
