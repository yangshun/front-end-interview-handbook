import { readySystemDesignQuestions } from '~/components/interviews/questions/content/system-design/SystemDesignNavigation';
...
- Every question format, including
  - [Front end coding interview questions](/)
