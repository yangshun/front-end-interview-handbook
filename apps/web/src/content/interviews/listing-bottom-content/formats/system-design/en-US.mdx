...
- **R**equirements exploration (R): Clarify the scope and requirements by asking detailed questions to understand the problem thoroughly.
- **A**rchitecture / High-level design (A): Identify the key components of the system and how they interact.
- **D**ata model (D): Define the data entities and their relationships within the system.
- **I**nterface definition / API (I): Describe the APIs between components, explaining functionality, parameters, and responses.
- **O**ptimizations and deep dive (O): Discuss potential optimizations and key areas for improvement, such as performance or scalability.
