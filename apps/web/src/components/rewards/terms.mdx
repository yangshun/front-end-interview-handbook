...
These terms and conditions ("Terms") govern the participation in the 20% Discount Claim ("Discount Claim") offered by GreatFrontEnd's Interview Platform ("GreatFrontEnd") to eligible users.
...
- Participants have the opportunity to earn a 20% discount code ("Discount Code") valid for use on GreatFrontEnd Interview’s premium plan subscriptions.
