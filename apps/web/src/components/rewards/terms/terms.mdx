...
# GreatFrontEnd {PROMO_SOCIAL_DISCOUNT_PERCENTAGE}% Discount Claim Terms and Conditions

**Effective Date: 21st Dec 2023**

These terms and conditions ("Terms") govern the participation in the {PROMO_SOCIAL_DISCOUNT_PERCENTAGE}% Discount Claim ("Discount Claim") offered by GreatFrontEnd's Interview Platform ("GreatFrontEnd") to eligible users.
...
- Participants have the opportunity to earn a {PROMO_SOCIAL_DISCOUNT_PERCENTAGE}% discount code ("Discount Code") valid for use on GreatFrontEnd Interview's premium plan subscriptions.
