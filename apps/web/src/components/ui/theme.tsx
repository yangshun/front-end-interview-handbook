...
export const themeRadialWhiteGlowBackground = clsx(
  'relative before:opacity-20 before:-z-10 before:top-0 before:left-0 before:right-0 before:absolute before:w-full before:h-[658px] before:bg-top before:bg-cover',
  'before:bg-[radial-gradient(68.6%_68.61%_at_50.65%_0.84%,_#FFFFFF_0%,_#D4D4D8_0%,_rgba(15,_23,_42,_0.0001)_100%)]',
);
