    ...
    <svg
      ...
      <defs>
        ...
        <linearGradient
          ...
          y1="41.2432"
          y2="136.227">
          <stop stop-color="#EBFE7D" />
          <stop offset="1" stop-color="#8D984B" stop-opacity="0" />
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
        ...
        <linearGradient
          ...
          y1="97"
          y2="330.933">
          <stop stop-color="#39EA4A" />
          <stop offset="1" stop-color="#4A9C51" stop-opacity="0" />
        </linearGradient>
      </defs>
    </svg>
  );
