...
export default function MarketingBecause() {
  ...
  return (
    <div className="min-h-[450px] bg-slate-50 sm:min-h-[400px] md:min-h-[500px] lg:min-h-[600px]">
      <Container>
        <div className="mx-auto max-w-xl px-6 py-16 sm:max-w-3xl sm:px-12 md:max-w-4xl md:py-24 lg:max-w-5xl lg:py-32 xl:px-0">
          ...
          <div
            ...
            <Section>
              ...
              <p className="mx-auto mt-6 max-w-2xl text-center text-lg text-slate-500 md:text-xl lg:mt-10 lg:text-2xl">
                <FormattedMessage
