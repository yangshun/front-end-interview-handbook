...
export function InterviewsMarketingTestimonialsDict(intl: IntlShape) {
  ...
  const yuChienChan: InterviewsMarketingTestimonial = {
    ...
    featured: true,
    featuredOffer: 'Retool',
    fromCompany: 'Meta',
    id: 'yu-chien-chan',
    location: 'Seattle, US',
    name: 'Yu-Chien Chan',
    offers: ['Aviator', 'Databricks'],
    testimonial:
  ...
  const purplePaisley: InterviewsMarketingTestimonial = {
    ...
    featuredOffer: 'Small fintech startup',
    id: 'purple-paisley',
    location: 'New York City, US',
    name: 'Purple Paisely',
    testimonial: intl.formatMessage({
  ...
  const zizib2000: InterviewsMarketingTestimonial = {
    ...
    companyLogoUrl: '/img/testimonials/company/gitlab.svg',
    createdAt: '2024-04-23',
    featuredOffer: 'GitLab',
    id: 'zizib',
    location: 'Canada',
    name: 'Zizib',
    testimonial: intl.formatMessage({
  ...
  const lunghaoLee: InterviewsMarketingTestimonial = {
    anonymous: false,
    authorThumbnailUrl: '/img/testimonials/users/lunghao-lee.jpg',
    authorUrl: 'https://www.linkedin.com/in/lunghaol/',
    companyLogoUrl: '/img/testimonials/company/tiktok.svg',
    createdAt: '2024-02-14',
    featuredOffer: 'TikTok',
    fromCompany: null,
    ...
    testimonial: intl.formatMessage({
      defaultMessage:
        'GFE played a significant role at my five month job hunting journey, the best investment for me last year, and help me land a job to earn 4 times money then my previous one! Will recommend it to everyone who wants to prepare for FE interview.',
      description: 'User testimonial for GreatFrontEnd Interviews',
      id: '5HNQLS',
    }),
    title: 'Frontend Engineer',
  ...
  const faithKomlo: InterviewsMarketingTestimonial = {
    anonymous: true,
    companyLogoUrl: '/img/testimonials/company/rippling.svg',
    createdAt: '2024-06-01',
    featuredOffer: 'Rippling',
    id: 'faith-komlo',
    location: 'New York, US',
    name: 'Faith',
    offers: [],
  ...
  const jaydeMitchell: InterviewsMarketingTestimonial = {
    anonymous: false,
    authorThumbnailUrl: '/img/testimonials/users/jayde-mitchell.webp',
    authorUrl: 'https://www.linkedin.com/in/jaydedm/',
    companyLogoUrl: '/img/testimonials/company/amazon.svg',
  ...
  const praveenKumar: InterviewsMarketingTestimonial = {
    anonymous: false,
    authorThumbnailUrl: '/img/testimonials/users/praveen-kumar.webp',
    authorUrl: 'https://www.linkedin.com/in/decpk/',
    companyLogoUrl: '/img/testimonials/company/microsoft.svg',
    ...
    title: 'SDE 2 @Microsoft',
  };
  const jessieShen: InterviewsMarketingTestimonial = {
    anonymous: false,
    authorThumbnailUrl: '/img/testimonials/users/jessie-shen.webp',
    authorUrl: 'https://www.linkedin.com/in/jessiejxshen/',
    companyLogoUrl: '/img/testimonials/company/cash-app.svg',
    createdAt: '2025-07-03',
    featured: true,
    featuredOffer: 'Block (Cash App)',
    id: 'jessie-shen',
