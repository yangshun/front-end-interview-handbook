...
import DashboardFeaturedFocusAreas from '~/components/interviews/dashboard/DashboardFeaturedFocusAreas';
import DashboardOnboarding from '~/components/interviews/dashboard/DashboardOnboarding';
import DashboardOverallCompletionProgress from '~/components/interviews/dashboard/DashboardOverallCompletionProgress';
import DashboardPageHeader from '~/components/interviews/dashboard/DashboardPageHeader';
