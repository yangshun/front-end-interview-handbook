...
import ProjectsChallengeDiscussionPost from './ProjectsChallengeDiscussionPost';
import { exampleDiscussionPosts } from './ProjectsChallengeDiscussionSection';
...
export default function ProjectsChallengeDiscussionSubposts({ postId }: Props) {
    ...
    <>
      {subPosts.map((post, index) => (
        <div key={post.id} className="relative flex">
          ...
          <ProjectsChallengeDiscussionPost
