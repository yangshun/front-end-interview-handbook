...
export default function QuestionsProgressPanel({
  ...
  return (
    <div className="flex items-center overflow-hidden rounded-lg border border-slate-200 bg-white p-4">
      <div className="-m-1 flex-shrink-0 rounded-md bg-slate-50 p-1">
