import { type editor as Editor, Selection } from 'monaco-editor';
...
export default function useMonacoEditorAddFormatter(
  ...
  const format = useCallback(async () => {
    ...
    switch (fileExtension) {
      ...
      case 'tsx':
        ...
        // no clue why it doesnt have a type definition though
    ...
    try {
      ...
      if (fileExtension !== 'svelte') {
        ...
        newCursorPosition = [
          new Selection(lineNumber, column, lineNumber, column),
        ];
      }
  ...
  }, [editor, filePath, showErrorToast]);
