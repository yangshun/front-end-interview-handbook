  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex items-center justify-center h-full flex-1 flex-col gap-4">
        <RiLink className={clsx('h-10 w-10', themeTextSecondaryColor)} />
        <div className="max-w-[360px] md:px-0 px-4 flex flex-col justify-center items-center">
          ...
          <Heading className="truncate md:max-w-lg max-w-full" level="heading5">
            {externalUrl}
          </Heading>
          <Text
