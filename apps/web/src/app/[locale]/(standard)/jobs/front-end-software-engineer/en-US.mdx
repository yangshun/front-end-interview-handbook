...
- Experience with our current technical stack:
  - React-based rendering frameworks like Next.js, Docusaurus. Knowledge or experience with React Server Components (GreatFrontEnd uses Next.js 13 app directory).
