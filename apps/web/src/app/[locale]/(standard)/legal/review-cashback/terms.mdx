...
_Effective date: 4th Jun 2023_

These terms and conditions ("**Terms**") govern the participation in the review cashback program ("Program") offered by GreatFrontEnd's Interview Platform ("**GreatFrontEnd**") to eligible users.
...
- Participants must have completed at least 20 coding or system design questions on GreatFrontEnd, which entails passing all the associated test cases. This ensures reviewers have sufficient experience with the platform prior to writing the review.
...
- Upon successful validation, the participant will be eligible to receive a 40% cashback of the Platform's cost, subject to the limitations mentioned in these Terms.
...
- The cashback amount will be 40% of the original cost of the reviewer's first purchase amount, excluding any taxes, fees, or additional charges.
- The cashback is limited to one per eligible participant.
