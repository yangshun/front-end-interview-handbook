    ...
    <div className="bg-neutral-950" id="pricing">
      <Container className="relative isolate" variant="narrow">
        <div
          ...
          <div
            className="sm:left-[calc(50%-30rem)] sm:w-[72.1875rem] from-brand-light to-brand-dark relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr opacity-20"
            style={{
              clipPath:
