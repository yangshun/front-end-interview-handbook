...
import depthFirstSearch from '../src/depth-first-search';
import depthFirstSearchRecursive from '../src/depthFirstSearchRecursive';
...
<MDXCodeBlock>{depthFirstSearch}</MDXCodeBlock>
