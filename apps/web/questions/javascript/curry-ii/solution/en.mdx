...
import curry from '../src/curry-ii';
...
The solution for this question is exactly the same as the solution for [Curry](/questions/javascript/curry/), which doesn't make any assumptions on the number of arguments needed.
