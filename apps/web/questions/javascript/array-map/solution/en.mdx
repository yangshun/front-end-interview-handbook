...
Here's a solution that is based off the [`Array.prototype.map` ECMAScript specification](https://tc39.es/ecma262/multipage/array-maped-collections.html#sec-array.prototype.map).
...
- [`Array.prototype.map` ECMAScript specification](https://tc39.es/ecma262/multipage/array-maped-collections.html#sec-array.prototype.map)
