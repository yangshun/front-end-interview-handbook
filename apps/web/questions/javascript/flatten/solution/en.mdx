...
import flattenFlatMap from '../src/flattenFlatMap';
import flattenGenerator from '../src/flattenGenerator';
import flattenInPlace from '../src/flattenInPlace';
import flattenIter from '../src/flattenIter';
import flattenIterSome from '../src/flattenIterSome';
import flattenJSONStringify from '../src/flattenJSONStringify';
...
<MDXCodeBlock>{flatten}</MDXCodeBlock>
...
As we have discussed earlier, if the array has a thousands-of-levels nesting, a recursive approach might cause a stack overflow. We can utilize generators to yield array item individually. As generators are _lazy_ in nature, this wouldn't have as big of an upfront cost as our recursive approach does.
