...
import camelCaseKeys from '../src/camel-case-keys';
...
- Converting the object into an array of keys with `Object.keys`, or an array of a key-value tuple with `Object.entries`. This approach works if we don't care about Symbol keys and non-enumerable keys. Often times this is indeed the case.
...
<MDXCodeBlock>{camelCaseKeys}</MDXCodeBlock>
