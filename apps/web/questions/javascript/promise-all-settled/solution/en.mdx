...
import promiseAllSettled from '../src/promise-all-settled';
import promiseAllSettledThen from '../src/promiseAllSettledThen';
...
<MDXCodeBlock>{promiseAllSettled}</MDXCodeBlock>
