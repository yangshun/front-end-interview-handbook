...
import rangeRightGFE from './range-right';
import rangeRightReverse from './range-right-reverse';

describe('rangeRight', () => {
  [rangeRightLodash, rangeRightGFE, rangeRightReverse].forEach((rangeRight) => {
