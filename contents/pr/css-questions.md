...
- <a href="#04">Descreva o z-index e como o contexto de empilhamento é formado.</a>
- <a href="#05">Descreva o BFC (Block Formatting Context) e como ele funciona.</a>
...
<i>Nota: O que exatamente qualifica um elemento para criar um contexto de empilhamento está listado neste longo conjunto de <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Positioning/Understanding_z_index/The_stacking_context#the_stacking_context">regras</a>.</i>
...
### <p id="05">Descreva o BFC (Block Formatting Context) e como ele funciona.</a>
...
Saber como estabelecer um contexto de formatação de bloco é importante, pois, sem isso, a caixa que o contém não conterá <a href="https://developer.mozilla.org/en-US/docs/Web/Guide/CSS/Block_formatting_context#Make_float_content_and_alongside_content_the_same_height">filhos flutuantes<a>. Isso é semelhante ao colapso de margens, mas mais insidioso, pois você encontrará caixas inteiras colapsando de maneiras estranhas.
...
Margens verticais entre caixas de nível de bloco adjacentes em um colapso BFC. Leia mais sobre <a href="https://www.sitepoint.com/collapsing-margins/">redução de margens</a>.
...
### <p id="06">Quais são as várias técnicas de limpeza e quais são apropriadas para qual contexto?</a>
...
### <p id="07">Explique os sprites CSS e como você os implementaria em uma página ou site.</a>
...
[1]Use um gerador de sprite que reúna várias imagens em uma e gere o CSS apropriado para isso.
[2]Cada imagem teria uma classe CSS correspondente com propriedades de ```background-image```, ```background-position``` e ```background-size``` definidas.
